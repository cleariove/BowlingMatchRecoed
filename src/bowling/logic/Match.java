...
public class Match
{
    ...
    //设置小组该比赛总分
    {
        ...
        for(int i = 0;i < joinMembers;i++)
        {
            ...
            {
                case "单人赛":
                    allPlayers.get(i).setSingleScore(roundRecords[0][0].get(i).getTeamMatchScore());
                    break;
                case "双人赛":
                    allPlayers.get(i).setDoubleScore(roundRecords[0][0].get(i).getTeamMatchScore());
                    break;
                case "三人赛":
                    allPlayers.get(i).setTripleScore(roundRecords[0][0].get(i).getTeamMatchScore());
                    break;
                case "五人赛":
                    allPlayers.get(i).setPentaScore(roundRecords[0][0].get(i).getTeamMatchScore());
                    break;
                case "精英赛":
                    allPlayers.get(i).setClassicScore(roundRecords[0][0].get(i).getTeamMatchScore());
                    break;
                case "四强赛":
                    allPlayers.get(i).setTopFourScore(roundRecords[0][0].get(i).getTeamMatchScore());
                    break;
                case "三强赛":
                    allPlayers.get(i).setTopThreeScore(roundRecords[0][0].get(i).getTeamMatchScore());
                    break;
                case "总决赛":
                    allPlayers.get(i).setFinalScore(roundRecords[0][0].get(i).getTeamMatchScore());
                    break;
            }
        }
    }
